  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }} initialRouteName={initialRoute}>
        <Stack.Screen name={i18n.t('dashboard.homepage')} component={MainTabNavigator} />
        <Stack.Screen name={i18n.t('login')} component={Login} />
        <Stack.Screen name={i18n.t('register')} component={Register} />
